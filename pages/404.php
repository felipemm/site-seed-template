...
<html lang="en">
    <head>
        ...
        <title><?php echo HEAD_TITLE . " - " . gettext("Page not found!"); ?></title>
    ...
    <body>
        <?php include("sketches/header.php"); ?>
        <br>
        <br>
        <hr>
        <div class="container">
            ...
            <br>
            <p>The page you requested was not found. are you sure you typed correctly?.</p>
        </div>
        <hr>
